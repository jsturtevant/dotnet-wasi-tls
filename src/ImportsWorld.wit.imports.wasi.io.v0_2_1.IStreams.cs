...
public interface IStreams {
    ...
    */
    ...
    public class StreamError {
        ...
        public static StreamError LastOperationFailed(global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IError.Error lastOperationFailed) {
        ...
        public global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IError.Error AsLastOperationFailed
        {
            get
            {
                if (Tag == Tags.LastOperationFailed)
                return (global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IError.Error)value!;
                else
    ...
    */
    ...
    public class InputStream: IDisposable {
        ...
        public   unsafe byte[] Read(ulong len)
        {
            ...
            Result<byte[], global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError> lifted6;
            ...
            switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                case 0: {
                    ...
                    lifted6 = Result<byte[], global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.Ok(array);
                    break;
                }
                case 1: {

                    global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError lifted;
                    ...
                    switch (new Span<byte>((void*)(ptr + 4), 1)[0]) {
                        case 0: {
                            ...
                            lifted = global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError.LastOperationFailed(resource);
                            break;
                        }
                        case 1: {

                            lifted = global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError.Closed();
                            break;
                        }
                    ...
                    lifted6 = Result<byte[], global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.Err(lifted);
                    break;
                }
            ...
            {
                throw new WitException<global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>(lifted6.AsErr!, 0);
            }
        ...
        public   unsafe ulong Skip(ulong len)
        {
            ...
            Result<ulong, global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError> lifted6;

            switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                case 0: {

                    lifted6 = Result<ulong, global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.Ok(unchecked((ulong)(BitConverter.ToInt64(new Span<byte>((void*)(ptr + 8), 8)))));
                    break;
                }
                case 1: {
                    ...
                    switch (new Span<byte>((void*)(ptr + 8), 1)[0]) {
                        case 0: {
                            var resource = new global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IError.Error(new global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IError.Error.THandle(BitConverter.ToInt32(new Span<byte>((void*)(ptr + 12), 4))));
                    ...
                    lifted6 = Result<ulong, global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.Err(lifted);
                    break;
                }
    ...
    */
    ...
    public class OutputStream: IDisposable {
        ...
        public   unsafe void Write(byte[] contents)
        {
            ...
            Result<None, global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError> lifted6;

            switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                case 0: {

                    lifted6 = Result<None, global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.Ok(new global::ImportsWorld.None());
                    break;
                }
                case 1: {
                    ...
                    lifted6 = Result<None, global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.Err(lifted);
                    break;
                }
        ...
        public   unsafe ulong Splice(global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.InputStream src, ulong len)
        {
            var handle = this.Handle;
            ...
            Result<ulong, global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError> lifted7;

            switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                case 0: {

                    lifted7 = Result<ulong, global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.Ok(unchecked((ulong)(BitConverter.ToInt64(new Span<byte>((void*)(ptr + 8), 8)))));
                    break;
                }
                case 1: {
                    ...
                    lifted7 = Result<ulong, global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>.Err(lifted);
                    break;
                }
            ...
            {
                throw new WitException<global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.StreamError>(lifted7.AsErr!, 0);
            }
        ...
        public   unsafe ulong BlockingSplice(global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IStreams.InputStream src, ulong len)
        {
            var handle = this.Handle;
            var handle0 = src.Handle;
