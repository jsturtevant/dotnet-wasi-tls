...
namespace ImportsWorld.wit.imports.wasi.io.v0_2_1
{
    public static class PollInterop {
        ...
        public  static unsafe uint[] Poll(List<global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IPoll.Pollable> @in)
        {
            ...
            for (int index = 0; index < @in.Count; ++index) {
                global::ImportsWorld.wit.imports.wasi.io.v0_2_1.IPoll.Pollable element = @in[index];
